...
const BuyerQuotation = () => {
  ...
  const handleWithdraw = async (quotationId) => {
    ...
    try {
      const response = await ApiService.withdrawQuotation(quotationId);
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">
          Track all quotations you've submitted to dealers
        </p>
      </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">
                      Dealer: {quotation.listing?.scrapRecord?.owner?.companyName || "Unknown"}
                    </span>
                  </div>
